...
({
    ...
    resolveFieldDefination : function(component, fieldDefinations) {
        ...
        for (var key in fieldDefinations) {
            ...
            } else if (fieldDefination.name === "EmployeePhoto__c") {
                fieldDefination.type = "file";
                fieldDefination.columnSize = 10;
                fieldDefination.labelColumnSize = 10;
                fieldDefination.valueColumnSize = 12;
